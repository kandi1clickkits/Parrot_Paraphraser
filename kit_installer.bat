...
ECHO======================================================================================
SET KIT_NAME=Parrot_Paraphraser
...
SET REPO_DEPENDENCIES_URL=https://github.com/kandi1clickkits/Parrot_Paraphraser/raw/main/requirements.txt
...
SET VIRTUALENV_NAME=Parrot_Paraphraser-env
